...
const Navbar = () => {
  ...
  return (
    <div className="w-[100%] h-[10%] flex flex-col justify-center bg-gray-700 text-white">
      <div className='flex justify-between items-center py-3 px-10 md:py-3 md:px-16 '>
        ...
        <div className='text-[16px] font-semibold text-white flex items-center'>
            ...
            <Link to="/cart"><p className='px-4'>Cart<span>({cart.length})</span></p></Link>
